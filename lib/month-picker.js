...
var MonthPicker = function (_Component) {
    ...
    _createClass(MonthPicker, [{
        ...
        value: function optionPad(padIndex) {
            ...
            var rangeSelected = isRange ? "selected" : '';
            var shouldRenderRangeButton = padIndex === 0 ? 'visible' : 'invisible';
                    ...
                    _react2.default.createElement(
                        'button',
                        {
                            ...
                            onClick: function onClick(event) {
                                console.log("[Month picker]: Old state...", _this2.state);
                                var newState = {
                                    rawValue: convertRawValue(rawValue),
                                    yearIndexes: rawValue.range === 'single' ? [_this2.state.yearIndexes[0]] : [_this2.state.yearIndexes[0], _this2.state.yearIndexes[0]]
                                };
                                console.log("[Month picker]: new state: ", newState);
                                var finalState = Object.assign({}, _this2.state, newState);
                                console.log("[Month picker]: Final state: ", finalState);
